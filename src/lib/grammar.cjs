...
var grammar = {
    ...
    {"name": "ExprCalcMultiPart$ebnf$1", "symbols": ["ExprCalcMultiPart$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "ExprCalcMultiPart$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    ...
    {"name": "ExprCalcMultiPart$ebnf$3$subexpression$1", "symbols": [(lexer.has("ArgsEnd") ? {type: "ArgsEnd"} : ArgsEnd), "_"]},
    {"name": "ExprCalcMultiPart$ebnf$3", "symbols": ["ExprCalcMultiPart$ebnf$3$subexpression$1"], "postprocess": id},
    {"name": "ExprCalcMultiPart$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    ...
    {"name": "ExprCalcMulti$ebnf$1", "symbols": ["ExprCalcMulti$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "ExprCalcMulti$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
