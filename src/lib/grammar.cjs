...
var grammar = {
    ...
    {"name": "SectionState", "symbols": [(lexer.has("VarName") ? {type: "VarName"} : VarName), "_", (lexer.has("BlockStart") ? {type: "BlockStart"} : BlockStart), "_", "SectionState$ebnf$1", (lexer.has("BlockEnd") ? {type: "BlockEnd"} : BlockEnd)], "postprocess":  d => ({
        	name: d[0].value,
        	vars: d[4]
        }) },
    ...
    {"name": "Function$ebnf$2$subexpression$1", "symbols": ["RegNumDef"]},
    ...
    {"name": "Function$ebnf$3", "symbols": ["Function$ebnf$3", "FunctionDefArgs"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "Function", "symbols": ["Function$ebnf$1", "_", (lexer.has("FunctionType") ? {type: "FunctionType"} : FunctionType), "Function$ebnf$2", "_", (lexer.has("VarName") ? {type: "VarName"} : VarName), (lexer.has("ArgsStart") ? {type: "ArgsStart"} : ArgsStart), "_", "Function$ebnf$3", "_", (lexer.has("ArgsEnd") ? {type: "ArgsEnd"} : ArgsEnd), "Function$subexpression$1"], "postprocess": 
        d => ({
        	annotations: d[0],
        	type: d[2].value,
    ...
    {"name": "ExprCalcAll", "symbols": ["ExprCalcMulti"]},
    ...
    {"name": "ExprNum", "symbols": ["ValueNumeric"], "postprocess": d => ({type: "num", value: d[0][0]})},
    {"name": "ExprVarName", "symbols": [(lexer.has("VarName") ? {type: "VarName"} : VarName)], "postprocess": d => ({type: "VarName",value: d[0].value})},
    {"name": "ExprCalcMultiPart$ebnf$1", "symbols": []},
    {"name": "ExprCalcMultiPart$ebnf$1$subexpression$1", "symbols": [(lexer.has("ArgsStart") ? {type: "ArgsStart"} : ArgsStart), "_"]},
    {"name": "ExprCalcMultiPart$ebnf$1", "symbols": ["ExprCalcMultiPart$ebnf$1", "ExprCalcMultiPart$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "ExprCalcMultiPart$subexpression$1", "symbols": ["ExprVarName"]},
    {"name": "ExprCalcMultiPart$subexpression$1", "symbols": ["ExprNum"]},
    {"name": "ExprCalcMultiPart$ebnf$2", "symbols": [(lexer.has("Swizzle") ? {type: "Swizzle"} : Swizzle)], "postprocess": id},
    {"name": "ExprCalcMultiPart$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ExprCalcMultiPart$ebnf$3", "symbols": []},
    {"name": "ExprCalcMultiPart$ebnf$3$subexpression$1", "symbols": ["_", (lexer.has("ArgsEnd") ? {type: "ArgsEnd"} : ArgsEnd)]},
    {"name": "ExprCalcMultiPart$ebnf$3", "symbols": ["ExprCalcMultiPart$ebnf$3", "ExprCalcMultiPart$ebnf$3$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "ExprCalcMultiPart", "symbols": [(lexer.has("OperatorLR") ? {type: "OperatorLR"} : OperatorLR), "_", "ExprCalcMultiPart$ebnf$1", "ExprCalcMultiPart$subexpression$1", "ExprCalcMultiPart$ebnf$2", "ExprCalcMultiPart$ebnf$3"], "postprocess":  d => ({
        	type: "calcMultiPart",
        	op: d[0].value,
        	right: d[3][0],
    ...
    {"name": "ExprCalcMulti$ebnf$1", "symbols": []},
    {"name": "ExprCalcMulti$ebnf$1$subexpression$1", "symbols": [(lexer.has("ArgsStart") ? {type: "ArgsStart"} : ArgsStart), "_"]},
    {"name": "ExprCalcMulti$ebnf$1", "symbols": ["ExprCalcMulti$ebnf$1", "ExprCalcMulti$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "ExprCalcMulti$subexpression$1", "symbols": ["ExprVarName"]},
    {"name": "ExprCalcMulti$subexpression$1", "symbols": ["ExprNum"]},
    {"name": "ExprCalcMulti$ebnf$2", "symbols": [(lexer.has("Swizzle") ? {type: "Swizzle"} : Swizzle)], "postprocess": id},
    {"name": "ExprCalcMulti$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ExprCalcMulti$ebnf$3$subexpression$1", "symbols": ["_", "ExprCalcMultiPart"]},
    {"name": "ExprCalcMulti$ebnf$3", "symbols": ["ExprCalcMulti$ebnf$3$subexpression$1"]},
    {"name": "ExprCalcMulti$ebnf$3$subexpression$2", "symbols": ["_", "ExprCalcMultiPart"]},
    {"name": "ExprCalcMulti$ebnf$3", "symbols": ["ExprCalcMulti$ebnf$3", "ExprCalcMulti$ebnf$3$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "ExprCalcMulti", "symbols": ["ExprCalcMulti$ebnf$1", "ExprCalcMulti$subexpression$1", "ExprCalcMulti$ebnf$2", "ExprCalcMulti$ebnf$3"], "postprocess":  d => ({
        	type: "calcMulti",
        	left: d[1][0],
