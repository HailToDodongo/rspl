...
var grammar = {
    ...
    {"name": "main$ebnf$3$subexpression$1", "symbols": ["_", "SectionTmpState"]},
    ...
    {"name": "main$ebnf$4$subexpression$1", "symbols": ["_", "Uniform"]},
    ...
    {"name": "main$ebnf$5$subexpression$1", "symbols": ["_", "VertexAttribute"]},
    ...
    {"name": "main$ebnf$6$subexpression$1", "symbols": ["Function"]},
    {"name": "main$ebnf$6", "symbols": ["main$ebnf$6", "main$ebnf$6$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "main$ebnf$7", "symbols": []},
    {"name": "main$ebnf$7$subexpression$1", "symbols": ["_", "SectionIncl"]},
    {"name": "main$ebnf$7", "symbols": ["main$ebnf$7", "main$ebnf$7$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "main", "symbols": ["main$ebnf$1", "main$ebnf$2", "main$ebnf$3", "main$ebnf$4", "main$ebnf$5", "main$ebnf$6", "main$ebnf$7", "_"], "postprocess":  d => ({
    ...
    {"name": "SectionTmpState$ebnf$1", "symbols": []},
    {"name": "SectionTmpState$ebnf$1", "symbols": ["SectionTmpState$ebnf$1", "StateVarDef"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "SectionTmpState", "symbols": [(lexer.has("KWTmpState") ? {type: "KWTmpState"} : KWTmpState), "_", (lexer.has("BlockStart") ? {type: "BlockStart"} : BlockStart), "_", "SectionTmpState$ebnf$1", (lexer.has("BlockEnd") ? {type: "BlockEnd"} : BlockEnd)], "postprocess": d => d[4]},
