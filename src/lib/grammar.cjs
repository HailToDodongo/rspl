...
var grammar = {
    ...
    {"name": "main$ebnf$4$subexpression$1", "symbols": ["Function"]},
    ...
    {"name": "main$ebnf$5$subexpression$1", "symbols": ["_", "SectionIncl"]},
    {"name": "main$ebnf$5", "symbols": ["main$ebnf$5", "main$ebnf$5$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "main", "symbols": ["main$ebnf$1", "main$ebnf$2", "main$ebnf$3", "main$ebnf$4", "main$ebnf$5", "_"], "postprocess":  d => ({
